...
export const companies: Company[] = [
  { name: 'Cascade Debt', role: 'Capital Markets Ops Manager', countries: '7+ countries', period: '2025 \u2013 Present', summary: 'Master-servicing implementation for international lending facilities across Mexico, Indonesia, and North America.', logo: '/images/logos/cascade.png', monogram: 'CD' },
  { name: 'Vaas', role: 'Ops & Implementations Manager', countries: '2 countries', period: '2024 \u2013 2025', summary: 'Owned finance, then operations and client implementations end-to-end.', logo: '/images/logos/vaas.png', monogram: 'V' },
  ...
  { name: 'Rappi', role: 'Global FP&A Treasury Manager', countries: '8+ countries', period: '2023 \u2013 2024', summary: 'Led global cash-flow forecasting \u2014 liquidity, working capital, and treasury process.', logo: '/images/logos/rappi.png', monogram: 'R' },
  { name: 'Nowports', role: 'Treasury Leader', countries: '8 countries', period: '2022 \u2013 2023', summary: 'Built treasury from zero, leading a team of 20; grew AUM from $50M to $105M.', logo: '/images/logos/nowports.png', monogram: 'NP' },
  ...
  { name: 'BlackRock', role: 'Corporate Treasury LatAm', countries: '9 countries', period: '2020 \u2013 2021', summary: 'Global treasury from the NYC central team \u2014 banking, KYC, FX, and cash.', logo: '/images/logos/blackrock.png', monogram: 'BR' },
